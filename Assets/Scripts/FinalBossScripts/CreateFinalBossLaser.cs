...
//    {
//        // Instanciar láser desde las 4 posiciones diferentes
//        InstanciarLaser(EnemyAtackPoint.position);
//        InstanciarLaser(EnemyAtackPoint1.position);
//        InstanciarLaser(EnemyAtackPoint2.position);
//        InstanciarLaser(EnemyAtackPoint3.position);
//    }

//    private void InstanciarLaser(Vector3 spawnPosition)
//    {
...
//{
//    public GameObject laserPrefab; // Prefab del láser
//    public GameObject laserPrefab2; // Segundo prefab del láser
//    public float velocidadLaser = 5f; // Velocidad del láser
//    public float TiempoGeneracionDeLaser = 3f; // Tiempo entre generaciones de láser
...
//        InstanciarLaser(EnemyAtackPoint2.position);
//        InstanciarLaser(EnemyAtackPoint3.position);
//        InstanciarLaser(EnemyAtackPoint4.position); // Nuevo punto de ataque
//    }
